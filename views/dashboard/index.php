...
<?php
		...
		echo'<table>';$colspan=16;
			echo'<tr bgcolor="#00CED1">';
			echo'<th class="crtl">Validation</th>';
			echo'<th id="nomprenom">Nom_Prénom_(Fils de )</th>';
			echo'<th class="crtl">Sexe</th>';
			echo'<th class="crtldate">Naissance</th>';
			echo'<th class="crtl">Age</th>';
			echo'<th class="crtldate">Décès</th>';
			echo'<th class="crtl">Heure</th>';
			echo'<th class="crtl">Service</th>';
			echo'<th class="crtl">DH</th>';
			...
			echo '<td align="center"  >'.$value['SERVICEHOSPIT'].'</td>';
			...
			echo '<td align="center" style="width:10px;" ><a target="_blank" title="Edition non autoriser"><img src="'.URL.'public/images/edit.png"   width="16" height="16" border="0" alt=""/></a></td>';
			echo '<td align="center" style="width:10px;" ><a class="delete" title="Suppression non autoriser"><img src="'.URL.'public/images/delete.png"   width="16" height="16" border="0" alt=""/></a></td>';
			}
		...
		HTML::multigraphe(30,340,'Décés par année et sexe  arreté au : ','deceshosp','DINS','SEX','M','F','='.Session::get('structure')) ;
		// HTML::multiPie(30,340,'Décés Par sexe  Arret Au : ','deceshosp','DINS','SEX','M','F','='.Session::get('structure')) ;
...
<?php 
	...
	// {
		...
		// echo '<a href="'.URL.'x/x/0">x</a>';echo '&nbsp;';
	// }
	echo '<a class="DECES"  id="annee"  href="'.URL.'dashboard/graphe/0">Année</a>';echo '&nbsp;'; 
	// HTML::merge('deceshospm','deceshosp') ;
...
<?php 
	...
	echo '<a class="DECES"  id="mois"  href="'.URL.'dashboard/graphe/1">Mois</a>';echo '&nbsp;';
?>
</div>
