...
echo "<button class=\"naissance\"  id=\"btna5\"   onclick=\"document.location='".URL."dashboard/reset/';\"title=\"Vider la structure  \">&nbsp;<img src=\"".URL."public/images/ok.jpg\" width='15' height='15' border='0' alt=''/>&nbsp;Vider Structure&nbsp;</button> " ;
echo "<button class=\"naissance\"  id=\"btna6\"   onclick=\"document.location='".URL."dashboard/reseti/';\"title=\"Initialiser la structure  \">&nbsp;<img src=\"".URL."public/images/ok.jpg\" width='15' height='15' border='0' alt=''/>&nbsp;Initialiser Structure&nbsp;</button> " ;
