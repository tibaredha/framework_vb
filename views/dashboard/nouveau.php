...
<div class="sheader2l">Créer un nouveau certificat de décès</div><div class="sheader2r">ID Défunt( e ) : <label style="display: none;" id="show_codeP"><input type="text" name="code_patient" id="code_patient"  style="border: none; background-color: green; color: white; border-radius: 15px; font-family:courier; text-align:center;  "   size="15" readonly=""></label></div>
<div class="listl">
