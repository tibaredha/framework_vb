...
"cb2" => $ctrl,"mb2" => '',               "tb2" => 'accueil',"vb2" => '',  "icon2" => 'b_home.png');
...
echo "<button id=\"Cleari\"  onclick=\"document.location='".URL.$data['cb2']."';  \"                     title=\"".$data['tb2']."\">&nbsp;<img src=\"".URL."public/images/".$data['icon2']."\" width='15' height='15' border='0' alt=''/>&nbsp;".$data['vb2']."&nbsp;</button> " ;
?>
</div>
<div class="contentl">
<?php 
