...
{
$sError='<p id="lregister">Modifier un compte </p>';
echo $sError;
}
...
<div class="sheader2l">Modifier un compte 
<?php //echo EDRSFR;?>
</div>
<div class="sheader2r">MSPRH</div><!---->
<div class="contentl formaut">
    <div class="form-style-10">
    <form class="tabaut"action="<?php echo URL;?>users/editSaveusers/<?php echo $this->id;?>" method="post">	
		...
		<div class="inner-wrap"><?php HTML::ROLE('role','role','role') ;?></div></br>
		...
		<div class="inner-wrap"><p> captcha <img src="<?php echo URL;?>views/users/captcha.php" /><input type="text" name="captcha"  value=""/></p></div>
