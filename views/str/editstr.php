...
<div class="sheader2l">Modifier une structure sanitaire
<?php 
$ctrl='cim';
$mdl='searchcim';
$data = array(
...
<div class="form-style-10">
	<form class="tabaut" method="post" action="<?php echo URL."str/editSave/".$this->user[0]['id'];?>">
	   
	    <div class="section"><span>1</span>Structure fr</div>
		<div class="inner-wrap"><input  type="text" name="structure" value="<?php echo $this->user[0]['structure'];?>"/></div>	
		<div class="section"><span>2</span>Structure ar</div>
		<div class="inner-wrap"><input  type="text" id ="structurear" name="structurear" value="<?php echo $this->user[0]['structurear'];?>"/></div>
	    </br>
