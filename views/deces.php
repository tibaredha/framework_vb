...
if (Session::get('role') == 'admin'){echo '<a href="'.URL.'dashboard/cfg/">Cfg <img src="'.URL.'public/images/cfg.jpg" width="16" height="16" border="0" alt=""/></a>';echo '&nbsp;'; }		
if (Session::get('role') == 'dsp'){echo '<a href="'.URL.'dspd/">DSP <img src="'.URL.'public/images/eva.png" width="16" height="16" border="0" alt=""/></a>';echo '&nbsp;'; }		
}
?>	
