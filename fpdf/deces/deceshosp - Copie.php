...
while($row=mysql_fetch_object($resultat))
{
   ...
   //Signalement mÈdico-légal- A remplir par le médecin (cocher la case adéquate)
	...
	$pdf->SetXY(48,136.8+16.5+25+35);$pdf->Write(0,html_entity_decode(utf8_decode($row->CIM2)));
	...
	$pdf->SetXY(15,136.8+16.5+25+50);$pdf->Write(0,html_entity_decode(utf8_decode($row->CIM5)));
